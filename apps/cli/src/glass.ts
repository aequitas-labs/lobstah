...
.lob .bub{display:none;position:absolute;bottom:20px;right:26px;z-index:2;background:var(--card);border:1px solid var(--line);border-radius:9px;padding:6px 9px 5px;font-size:11px;line-height:1.35;color:var(--fg);width:max-content;max-width:150px;box-shadow:0 2px 8px rgba(0,0,0,.4)}
...
.lob .star{position:absolute;left:56px;top:-9px;height:15px;image-rendering:pixelated}
